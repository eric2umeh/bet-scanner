...
def create_tip(
    ...
    *,
    ...
    tip = Tip(
        ...
        selection=_norm_sel(selection),
        odds_price=odds_price,
        bookmaker=_norm_book(bookmaker) if (bookmaker or "").strip() else None,
        stake_ngn=stake_ngn,
    ...
    *,
    ...
    for i, t in enumerate(tips):
        ...
        tip, status = create_tip(
            ...
            market=str(t["market"]).strip().lower(),
            selection=str(t["selection"]).strip().lower(),
            odds_price=t.get("odds_price", t.get("odds")),
            bookmaker=_norm_book(t.get("bookmaker")) if t.get("bookmaker") else t.get("bookmaker"),
            stake_ngn=stake,
