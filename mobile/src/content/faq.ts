...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Refresh prices on Home first (↻). Open Tools → Surebets → Find Nigeria surebets. Default scan: 1X2, O/U, BTTS, and team totals (both sides). International adds EU books (incl. O/U from the-odds-api). Copy or Log a stake plan; History keeps logged surebets.',
